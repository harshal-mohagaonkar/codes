# Load the libraries
library(arules)#mining
library(arulesViz)#visualisation
library(datasets)#dataset liya hai woh
...
itemFrequencyPlot(Groceries,topN=20,type="absolute")#top 20 frequnet items
...
subset.matrix <- is.subset(rules, rules)#to remove redundancy
